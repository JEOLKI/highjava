...
public class T02_ArrayListTest {
	...
	public static void main(String[] args) {
		...
		// 오류 : java.lang.ClassCastException: [Ljava.lang.Object; cannot be cast to [Ljava.lang.String;
		...
		String[] strArr2 = list2.toArray(new String[0]); //스트링이라는 배열의 객체(타입)를 얻어내야 가져온다.
