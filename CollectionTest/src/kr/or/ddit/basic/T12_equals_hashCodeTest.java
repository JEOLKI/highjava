...
public class T12_equals_hashCodeTest {
	...
	/*
		...
		HashSet, HashMap, Hashtable과 같은 객체들을 사용할 경우 객체가 
		서로 같은지를 비교하기 위해 equals()메서드와 hashCode()메서드를 호출한다.
		...
		2. 두 객체가 같으면 equals()메서드를 호출 했을 대 true를 반환해야 한다.
...
class Person {
	...
	public boolean equals(Object obj) {
		...
		if (obj == null)
			return false;
		if (getClass() != obj.getClass()) //객체를 만든 클래스가 같은지
			return false;
