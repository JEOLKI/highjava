...
public class T08_EnumTest {
	...
	*/
		...
		myCity1 = City.valueOf("서울"); // City enum에서 '서울'객체를 가져온다.
		...
		Season[] enumArr = Season.values(); // Season 타입의 배열을 반환
		...
		System.out.println("서울 => " + city.compareTo(city.서울)); // ordinal 값을 비교한것 서울0 대구 2
		System.out.println("대전 => " + city.compareTo(city.대전)); // 대구 2 대전 4 : -2
