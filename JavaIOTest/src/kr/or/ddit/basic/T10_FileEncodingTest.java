...
/*
	OutputStreamWriter객체 => OutputStream(바이트기반의 출력용 객체)을 Writer(문자기반이 출역용 객체)로 변환하는 객체
...
*/
	public static void main(String[] args) throws IOException {
		...
		OutputStreamWriter osw1 = new OutputStreamWriter(fos1, "utf-8"); // 기본스트림 필요 fos1
