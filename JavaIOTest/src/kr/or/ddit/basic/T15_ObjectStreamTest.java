		...
		try {
			...
			ObjectOutputStream oos = 
					new ObjectOutputStream( // 보조
							new BufferedOutputStream( // 보조
									new FileOutputStream("d:/D_Other/memObj.bin"))); // 기본
			...
			ObjectInputStream ois = 
					new ObjectInputStream( // 보조
							new BufferedInputStream( // 보조
									new FileInputStream("d:/D_Other/memObj.bin"))); // 기본
 ...
 * 회원정보 VO
 */
class Member implements Serializable { // 구현했는지 안했는지 체크하기위한 인터페이스이다.
